...
const Deleguerpurcas = {
  ...
  "Grand bara": ["Abdo Hamad"],
  Guestir: ["Mohamed Osman Ahmed"],
  Faradil: ["Abdillah Hassan Dirir"],
  Gami: ["Abdallah Robleh"],
  Gobaad: ["Mohamed Loita Ibrahim"],
  Hanle: ["Med Ali Kadito"],
  Harou: ["Moustalipha Hared Moussa"],
  Mouloud: ["Ayan Moussa Djama"],
  Sheikhatou: ["Areita"],
  Abaitou: ["Hamadou Gadito Mohamed"],
  Sankal: ["Abdillahi Mahamoud Robleh"],
  Gagadé: ["Abdo Med Moussa"],
